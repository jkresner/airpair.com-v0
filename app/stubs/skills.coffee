...
@stubs.skills = [
  ...
  @python = aSkill 36231, 'Python', 'python', 'python'
  @redis = aSkill 37231, 'Redis', 'redis', 'redis'
  @ror = aSkill 37232, 'Ruby on Rails', 'ror', 'ruby-on-rails'
  @ruby = aSkill 37233, 'Ruby', 'rubymotion', 'rubymotion'
  @rubymotion = aSkill 37234, 'Ruby Motion', 'ruby', 'ruby'
  @jasmine = aSkill 39215, 'Jasmine', 'jasmine', 'jasmine'
  @java = aSkill 39227, 'Java', 'java', 'java'
  @javascript = aSkill 39238, 'JavaScript', 'js', 'javascript'
  @jquery = aSkill 39249, 'jQuery', 'jquery', 'jquery'
  @php = aSkill 44236, 'PHP', 'php', 'php'
  @socketio = aSkill 44236, 'Socket.io', 'socketio', 'socket.io'
