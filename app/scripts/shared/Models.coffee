...
class exports.Company extends BB.BadassModel
  ...
  validation:
    name:           { required: true }
    about:          { rangeLength: [140, 5000], msg: 'Provide a reasonable amount of detail (min 140 characters) about your company so experts can asses if they are a good match' }
